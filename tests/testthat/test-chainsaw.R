...
test_that("Answers match up in the ultrametric case", {
  ...
  super2 <- metacommunity(leaf.abundance, tree2) # type_weights
  
  expect_equivalent(normalised.metacommunity.alpha(super, 0:2), 
                    normalised.metacommunity.alpha(super2, 0:2))
