...
test_that("metacommunity() works for phybranch diversity", {
  ...
  meta <- metacommunity(partition, similarity)
  tmp <- matrix(c(0.03636097, 0.03636097,
                  0.05884504, 0.05884504,
                  0.06309245, 0.06309245,
                  0.03010863, 0.03010863,
                  0.05884504, 0.05884504,
                  0.02989231, 0.02989231,
                  0.03010863, 0.03010863,
                  0.05884504, 0.05884504,
                  0.03775876, 0.03775876,
                  0.04467820, 0.04467820,
                  0.00678673, 0.00678673,
                  0.04467820, 0.04467820), ncol = 2, byrow = TRUE)
  rownames(tmp) <- c("1,7-1", "1,6-7", "2,8-2", "2,7-8", "2,6-7", "3,8-3",
                     "3,7-8", "3,6-7", "4,9-4", "4,6-9", "5,9-5", "5,6-9")
  expect_equal(meta@type_abundance, tmp, tolerance = 1e-05)
  tmp <- matrix(c(1.050354, 1.050354, 0.0000000, 0.0000000, 0.0000000,
                  0.0000000, 0.000000, 0.0000000, 0.00000, 0.00000, 0.000000,
                  0.000000, #1
                  1.0503539, 1.0503539, 0.6576952, 0.6576952, 0.6576952,
                  0.8414251, 0.8414251, 0.8414251, 0.00000, 0.00000, 0.000000,
                  0.000000, #2
                  0.00000, 0.00000, 0.6576952, 0.6576952, 0.6576952,
                  0.00000, 0.00000, 0.00000, 0.00000, 0.00000,
                  0.000000, 0.000000, #3
                  0.0000000, 0.0000000, 0.6576952, 0.6576952, 0.6576952,
                  0.8414251, 0.8414251, 0.8414251, 0.00000, 0.00000, 0.000000,
                  0.000000, #4
                  1.0503539, 1.0503539, 0.6576952, 0.6576952, 0.6576952,
                  0.8414251, 0.8414251, 0.8414251, 0.00000, 0.00000, 0.000000,
                  0.000000, #5
                  0.000000, 0.0000000, 0.000000, 0.0000000, 0.0000000,
                  0.8414251, 0.8414251, 0.8414251, 0.00000, 0.00000, 0.000000,
                  0.000000, #6
                  0.0000000, 0.0000000, 0.6576952, 0.6576952, 0.6576952,
                  0.8414251, 0.8414251, 0.8414251, 0.00000, 0.00000, 0.000000,
                  ...
                  0.0000000, 0.000000, 0.000000, 1.213048, 1.213048, 0.000000,
                  0.000000, #9
                  0.0000000, 0.0000000, 0.0000000, 0.0000000, 0.0000000,
                  0.0000000, 0.000000, 0.000000, 1.213048, 1.213048, 1.943071,
                  1.943071, #10
                  0.0000000, 0.0000000, 0.0000000, 0.0000000, 0.0000000,
                  0.0000000, 0.000000, 0.000000, 0.00000, 0.000000, 1.943071,
                  1.943071, #11
                  0.0000000, 0.0000000, 0.0000000, 0.0000000, 0.0000000,
                  0.0000000, 0.000000, 0.000000, 1.213048, 1.213048, 1.943071,
                  1.943071), ncol = 12, byrow = TRUE)
  colnames(tmp) <- c("1,7-1", "1,6-7", "2,8-2", "2,7-8", "2,6-7", "3,8-3",
                     "3,7-8", "3,6-7", "4,9-4", "4,6-9", "5,9-5", "5,6-9")
  rownames(tmp) <- c("1,7-1", "1,6-7", "2,8-2", "2,7-8", "2,6-7", "3,8-3",
                     "3,7-8", "3,6-7", "4,9-4", "4,6-9", "5,9-5", "5,6-9")
  expect_equal(meta@similarity, tmp, tolerance = 1e-05)
  ...
  meta@ordinariness
  expect_equal(meta@subcommunity_weights, c(0.5, 0.5))
  tmp <- matrix(c(0.07272193, 0.07272193,
                  0.11769009, 0.11769009,
                  0.12618489, 0.12618489,
                  0.06021726, 0.06021726,
                  0.11769009, 0.11769009,
                  0.05978462, 0.05978462,
                  0.06021726, 0.06021726,
                  0.11769009, 0.11769009,
                  0.07551752, 0.07551752,
                  0.08935639, 0.08935639,
                  0.01357346, 0.01357346,
                  0.08935639, 0.08935639), ncol = 2, byrow = TRUE)
  rownames(tmp) <- c("1,7-1", "1,6-7", "2,8-2", "2,7-8", "2,6-7", "3,8-3",
                     "3,7-8", "3,6-7", "4,9-4", "4,6-9", "5,9-5", "5,6-9")
  expect_equal(meta@type_weights, tmp, tolerance = 1e-05)
