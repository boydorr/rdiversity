...
#' diversity of a series of columns representing independent subcommunities
#' counts relative to a total supercommunity (by default the sum of the
#' subcommunities), for a series of orders, repesented as a 
#' vector of \code{qs}.
#'
