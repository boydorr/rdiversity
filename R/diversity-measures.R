...
#' 
#' \code{normalised_sub_alpha()} is used to calculate the 
#' similarity-sensitive diversity of subcommunity \emph{j} in isolation.
#' 
#' \code{normalised_sub_alpha()} calculates the normalised subcommunity 
...
#' 
normalised_sub_alpha <- function(meta, qs) 
...
#' 
#' \code{normalised_sub_beta()} is used to calculate an 
#' estimate of the effective number of distinct subcommunities.
#' 
#' \code{normalised_sub_beta()} calculates the normalised subcommunity beta 
...
#' normalised_sub_beta(meta, 0:2)
#' 
normalised_sub_beta <- function(meta, qs) 
...
#' 
#' \code{normalised_sub_rho()} is used to calculate the 
#' representativeness of subcommunity \emph{j}.
#' 
#' \code{normalised_sub_rho()}, the inverse of \code{normalised_sub_beta}), 
...
#' normalised_sub_rho(meta, 0:2)
#' 
normalised_sub_rho <- function(meta, qs) 
...
#' 
#' \code{normalised_meta_alpha()} is used to calculate the 
#' average similarity-sensitive diversity of subcommunities.
#' 
#' \code{normalised_meta_alpha()} calculates the total
...
#' normalised_meta_alpha(meta, 0:2)
#' 
normalised_meta_alpha <- function(meta, qs) 
...
#' 
#' \code{normalised_meta_beta()} is used to calculate the 
#' effective number of distinct subcommunities.
#' 
#' \code{normalised_meta_beta()} calculates the total
...
#' normalised_meta_beta(meta, 0:2)
#' 
normalised_meta_beta <- function(meta, qs) 
...
#' 
#' \code{normalised_meta_rho()} is used to calculate the 
#' average representativeness of subcommunities.
#' 
#' \code{normalised_meta_rho()} calculates the total normalised 
...
#' normalised_meta_rho(meta, 0:2)
#' 
normalised_meta_rho <- function(meta, qs) 
