...
#' diversity of a series of columns representing subcommunity counts, for a 
#' series of orders, repesented as a vector of \code{qs}.
#'
...
function(populations, qs, normalise = F)
{
  ...
  # Turn all columns into proportions if needed
  ds <- subcommunity.alpha(populations, qs, normalise)
  ...
  output <- new('rdiv', res, measure = 'Supercommunity A',
